#
#  Be sure to run `pod spec lint GCDispatch.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of GCDispatch in Markdown format.
  ...
  # s.authors          = { "Patrick Perini" => "pcperini@gmail.com", "other author" => "email@address.com" }
